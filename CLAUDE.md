...
| `john-j-chicago` | John Jorczak | Chicago / Indiana cluster — father of Adam (San Pierre IN), Harry (Chicago IL), Edwin (1922), and Rudy/Rudolph (Chicago IL) |
| `walter-anthony-1909` | Walter Anthony Jorczak | Chicago / Indiana branch — Walter & Eleanor Cross → Eugene Edward |
